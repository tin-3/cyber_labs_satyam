...
$username = "id21738126_root";
$password = "Cyber@satyam23";
$database = "id21738126_credentials";

$conn = mysqli_connect($servername, $username, $password, $database);

$username = $_SESSION['username'];

$folder1= 'imgholder/image1.png';
$folder2= 'imgholder/image2.png';
...
if(move_uploaded_file($tempname1, $folder1)){
   ...
   VALUES ('$copyuser', '$folder1', '$folder2', '$folder3', '$folder4', '$folder5', '$folder6', '$folder7', '$folder8', '$folder9')";
